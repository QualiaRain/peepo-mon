...
static void CreateDexNavWildMon(u16 species, u8 potential, u8 level, u8 abilityNum, u16 item, u16 *moves)
{
    ...
    CreateWildMonExact(species, level);  // shiny rate bonus handled in CreateBoxMon; Exact: species is already randomizer-remapped
...
static void DexNavGenerateMoveset(u16 species, u8 searchLevel, u8 encounterLevel, u16 *moveDst)
{
    ...
    CreateWildMonExact(species, encounterLevel); // Exact: species is already randomizer-remapped
